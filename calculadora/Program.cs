...
while(iterar == 1)
{
    ...
    operacion = int.TryParse(auxiliar, out operacion);

    Console.WriteLine("Ingrese un numero");
    auxiliar = Console.ReadLine();
    num2 = double.TryParse(auxiliar, out num2);


    switch(operacion)
    {
        case 1: Operaciones.Suma(num2);
                Console.WriteLine($"Reultado: {Operaciones.Resultado}");
        break;

        case 2: Operaciones.Restar(num2);
                Console.WriteLine($"Reultado: {Operaciones.Resultado}");
        break;

        case 3: Operaciones.Multiplicar(num2);
                Console.WriteLine($"Reultado: {Operaciones.Resultado}");
        break;
